...
def get_options(args=None):
    parser = argparse.ArgumentParser(
        description="Attention based model for solving the Vehicle routing problem with time window with Reinforcement Learning")
    ...
    parser.add_argument('--distance_cost', type=float, default=100, help='distance cost coefficient for cost function.')
    parser.add_argument('--service_cost', type=float, default=0, help='distance cost coefficient for cost function.')
    parser.add_argument('--delay_cost', type=float, default=0.5, help='distance cost coefficient for cost function.')
    parser.add_argument('--early_cost', type=float, default=0.1, help='distance cost coefficient for cost function.')
    ...
    opts.cost_coefficients = {
        'distance': opts.distance_cost,
        'service': opts.service_cost,
